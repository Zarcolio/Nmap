...
REM https://docs.oracle.com/cd/E26576_01/doc.312/e24928/overview.htm#GSADG00004
...
REM https://www.ibm.com/support/pages/behavior-change-file-server-enabled-default-tls-port-8445
REM https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cusrst/admin/sccp_sip_srst/configuration/guide/SCCP_and_SIP_SRST_Admin_Guide/srst_secure_sccp_and_sip.html
